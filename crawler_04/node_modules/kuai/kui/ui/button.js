...
class Button extends GuaObject {
    ...
    __added(view) {
        ...
        if (self.text === undefined) {
            ...
            self.backgroundNormal = new ImageView(p, self.config.backgroundNormal)
            self.backgroundDown = new ImageView(p, self.config.backgroundDown)
            self.add(self.backgroundNormal)
            self.add(self.backgroundDown)
        } else {
            // 带文本的按钮
